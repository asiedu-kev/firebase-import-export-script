...
const serviceAccount = require("./config/firebas_config_gile.json");
...
admin.initializeApp({
  ...
  // databaseURL: "https://foodies-e41ad-firestore-dn.firebaseio.com"
  databaseURL: "https://yara-224ff-default-rtdb.firebaseio.com", // put your firebase-rtdb link
});
